...
বিমান টিকিটের দাম জানতে **কোথা থেকে, কোথায়, কবে, কয়জন এবং ওয়ান-ওয়ে/রিটার্ন** লিখুন। আমি এরপর সঠিকভাবে তুলনা করার পথ দেখাব।

astaa.store, রেমিট্যান্স, আকামা বা সৌদি/উপসাগরীয় নিয়মাবলী নিয়েও প্রশ্ন করতে পারেন।
...
*জরুরি টিকিট বুকিং বা ব্যক্তিগত সহায়তায় সরাসরি আমাদের WhatsApp: **${displayPhone}** এ নক দিতে পারেন।*`,
  ...
  const quickQuestions = [
    '✈️ রিয়াদ থেকে ঢাকা, ১৫ অক্টোবর, ১ জন, ওয়ান-ওয়ে—কম দামের টিকিট চাই',
